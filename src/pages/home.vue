...
<<<<<<< HEAD
        ...
        <div @click="$router.push({path: '/mine'})" v-show="userType === '1'">
        ...
        <!-- 司机 -->
        <div @click="$router.push({path: '/driver-page'})" v-show="userType === '2'">
          <!-- <img v-show="currentPath !== '/comm-home'" src="../assets/home2.png" alt=""> -->
          <img src="../assets/home2.png" alt="">
          <div :style="{color: currentPath === '/driver-page' ? '#C39862' : '#333333'}">门店</div>
        </div>
