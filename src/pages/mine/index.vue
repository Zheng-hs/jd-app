...
>>>>>>> ccbc751fca169edec7169baf32e03b002d50c317
      ...
      <div class="content" v-show="userType === '1'">
          <div class="message">
            <div>
              <img src="../../assets/u919.png" alt="">
              <div>门店：{{role.shopName}}</div>
            </div>
            <div>
              <img src="../../assets/u1265.png" alt="">
              <div>邀请码：{{role.shopInvite}}</div>
            </div>
            <div>
              <img src="../../assets/u295.png" alt="">
              <div>{{role.shopAddress}}</div>
            </div>
          </div>
          <div
          class="con-item"
          v-for="(item,index) in conLists"
          :key="index"
          @click="toPage(item)">
            <div>
      ...
      <div class="content" v-show="userType === '2'">
